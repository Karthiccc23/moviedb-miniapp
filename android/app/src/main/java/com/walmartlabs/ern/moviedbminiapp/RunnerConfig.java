package com.walmartlabs.ern.moviedbminiapp;

import com.walmartlabs.ern.container.miniapps.MoviedbMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = MoviedbMiniappActivity.class;
